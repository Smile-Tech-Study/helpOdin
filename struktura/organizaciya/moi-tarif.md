...
Также не учитываются заблокированные пользователи и пользователи из программ проекта Активные меры содействия занятости, студенты потоков, которые находятся в архиве.
