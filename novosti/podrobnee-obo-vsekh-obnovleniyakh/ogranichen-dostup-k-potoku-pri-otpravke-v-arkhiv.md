...
Ранее при отправке потока в архив появлялась отметка об этом, но каких-то ограничений по доступу к нему не было.\
...
При отправке потока в архив, студенту будут доступны оценки, даже если он неуспешно завершил обучение. 